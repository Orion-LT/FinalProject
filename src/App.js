...
const App = () => {
  ...
  // Обновленный список вузов и колледжей
  const universities = [
    ...
    { id: 4, name: 'Университет науки и технологий МИСИС', location: 'Москва, Ленинский проспект, д. 4', students: '10 000', rank: 'Топ-3 в инженерии', type: 'Университет', specialties: ['Инженерия', 'Материаловедение', 'Металлургия'], shortName: 'МИСИС' },
    ...
    { id: 7, name: 'Национальный исследовательский университет «Московский институт электронной техники»', location: 'Москва, Зеленоград, площадь Шокина, д. 1', students: '11 000', rank: 'Топ-3 в электронике', type: 'Университет', specialties: ['IT', 'Инженерия', 'Электроника'], shortName: 'НИУ МИЭТ' },
    ...
    { id: 12, name: 'Национальный исследовательский Московский государственный строительный университет', location: 'Москва, Ярославское ш., д. 26', students: '10 000', rank: 'Топ-2 в строительстве', type: 'Университет', specialties: ['Инженерия', 'Строительство', 'Архитектура'], shortName: 'НИУ МГСУ' },
    { id: 13, name: 'Московский государственный институт международных отношений Министерства иностранных дел РФ', location: 'Москва, проспект Вернадского, д. 76', students: '9 000', rank: 'Топ-1 в международных отношениях', type: 'Институт', specialties: ['Международные отношения', 'Политология', 'Лингвистика'], shortName: 'МГИМО' },
    { id: 14, name: 'Первый Московский государственный медицинский университет им. И.М. Сеченова', location: 'Москва, ул. Трубецкая, д. 8, стр. 2', students: '14 000', rank: 'Топ-1 в медицине', type: 'Университет', specialties: ['Медицина', 'Фармация', 'Биология'], shortName: 'ФГАОУ Сеченова' },
    { id: 15, name: 'Московский городской педагогический университет', location: '2-й Сельскохозяйственный проезд, д. 4', students: '13 000', rank: 'Топ-3 в педагогике', type: 'Университет', specialties: ['Педагогика', 'Психология', 'Образование'], shortName: 'МГПУ' },
    ...
    { id: 19, name: 'Российский химико-технологический университет им. Д.И. Менделеева', location: 'Москва, Миусская площадь, д. 9', students: '6 000', rank: 'Топ-2 в химии', type: 'Университет', specialties: ['Химия', 'Технологии', 'Материаловедение'], shortName: 'РХТУ им. Менделеева' },
    ...
    { id: 22, name: 'Московский государственный психолого-педагогический университет', location: 'Москва, ул. Сретенка, д. 29', students: '7 000', rank: 'Топ-2 в психологии', type: 'Университет', specialties: ['Психология', 'Педагогика', 'Социология'], shortName: 'МГППУ' },
    ...
    { id: 26, name: 'Колледж многоуровневого профессионального образования РАНХиГС', location: 'Москва, Волгоградский проспект, д. 43', students: '266', rank: 'Топ-1', type: 'Колледж', specialties: ['Экономика', 'Право', 'Государственное и муниципальное управление'], shortName: 'КМПО РАНХиГС' },
    { id: 27, name: 'Люберецкий техникум им. Героя Советского Союза, лётчика-космонавта Ю.А. Гагарина', location: 'Московская область, г. Люберцы, Октябрьский проспект, д. 114', students: '229', rank: 'Топ-2', type: 'Колледж', specialties: ['Авиация', 'Космонавтика', 'Инженерия'], shortName: 'Люберецкий техникум' },
    { id: 28, name: 'Университетский колледж БРИКС', location: 'Москва, ул. Ткацкая, д. 1', students: '224', rank: 'Топ-3', type: 'Колледж', specialties: ['Международные отношения', 'Экономика', 'Политология'], shortName: 'Университетский колледж БРИКС' },
    { id: 29, name: 'ЧОУ СПО "Университетский колледж"', location: 'Москва, ул. Краснобогатырская, д. 10', students: '218', rank: 'Топ-4', type: 'Колледж', specialties: ['IT', 'Экономика', 'Менеджмент'], shortName: 'Университетский колледж' },
    { id: 30, name: 'Колледж Архитектуры, Дизайна и Реинжиниринга №26', location: 'Москва, ул. Цимлянская, д. 7, стр. 1', students: '214', rank: 'Топ-5', type: 'Колледж', specialties: ['Архитектура', 'Дизайн', 'Инженерия'], shortName: 'КАДР №26' }
  ];
  // Карьерные сферы
  const careerFields = [
  ...
  const universityDirections = [
    { id: 1, university: 'Московский государственный университет им. М.В. Ломоносова', direction: 'Прикладная математика и информатика', faculty: 'Факультет вычислительной математики и кибернетики' },
    { id: 2, university: 'Московский физико-технический институт', direction: 'Информатика и вычислительная техника', faculty: 'Факультет радиотехники и кибернетики' },
