...
const App = () => {
  ...
  const universities = [
    ...
    { id: 2, name: 'МИСиС', location: 'Москва, Ленинский проспект, д. 4', students: '15 000', rank: 'Топ-5 в России', type: 'Институт', specialties: ['Инженерия', 'Материаловедение', 'Химия', 'Физика'], shortName: 'МИСиС' },
    { id: 3, name: 'СПбПУ', location: 'Санкт-Петербург, Политехническая ул., д. 29', students: '30 000', rank: 'Топ-3 в России', type: 'Политех', specialties: ['Инженерия', 'IT', 'Робототехника', 'Энергетика'], shortName: 'СПбПУ' },
    { id: 4, name: 'НИУ ВШЭ', location: 'Москва, ул. Мясницкая, д. 20', students: '25 000', rank: 'Топ-2 в России', type: 'Университет', specialties: ['Экономика', 'Право', 'Социология', 'IT'], shortName: 'ВШЭ' },
    { id: 5, name: 'МФТИ', location: 'Москва, ул. Институтский пер., д. 9', students: '8 000', rank: 'Топ-1 технический', type: 'Институт', specialties: ['IT', 'Физика', 'Математика', 'Инженерия'], shortName: 'МФТИ' },
    { id: 6, name: 'МГТУ им. Баумана', location: 'Москва, 2-я Бауманская ул., д. 5', students: '18 000', rank: 'Топ-3 технический', type: 'Политех', specialties: ['Инженерия', 'IT', 'Машиностроение', 'Робототехника'], shortName: 'Бауманка' },
    { id: 7, name: 'МГЮА им. Кутафина', location: 'Москва, ул. Садовая-Кудринская, д. 9', students: '12 000', rank: 'Топ-1 юридический', type: 'Университет', specialties: ['Право', 'Международные отношения', 'Политология'], shortName: 'МГЮА' },
    { id: 8, name: 'РУДН', location: 'Москва, ул. Миклухо-Маклая, д. 6', students: '28 000', rank: 'Топ-5 в России', type: 'Университет', specialties: ['Медицина', 'Инженерия', 'Экономика', 'Лингвистика'], shortName: 'РУДН' },
    { id: 9, name: 'Финансовый университет', location: 'Москва, ул. Ленинградский проспект, д. 4', students: '20 000', rank: 'Топ-1 экономический', type: 'Университет', specialties: ['Экономика', 'Финансы', 'Менеджмент', 'IT'], shortName: 'Финансовый' },
    { id: 10, name: 'РХТУ им. Менделеева', location: 'Москва, ул. Миусская, д. 26', students: '10 000', rank: 'Топ-1 химический', type: 'Институт', specialties: ['Химия', 'Материаловедение', 'Биотехнология', 'Фармация'], shortName: 'Менделеевка' },
    { id: 11, name: 'Московский политех', location: 'Москва, ул. Павла Корчагина, д. 2', students: '16 000', rank: 'Топ-5 технический', type: 'Политех', specialties: ['Инженерия', 'IT', 'Машиностроение', 'Робототехника'], shortName: 'Московский политех' },
    { id: 12, name: 'РГУНГ им. Губкина', location: 'Москва, Ленинский проспект, д. 33', students: '7 000', rank: 'Топ-1 нефтяной', type: 'Институт', specialties: ['Нефть и газ', 'Энергетика', 'Инженерия', 'Экономика'], shortName: 'Губкинка' },
    { id: 13, name: 'Первый МГМУ им. Сеченова', location: 'Москва, ул. Б. Пироговская, д. 2', students: '13 000', rank: 'Топ-1 медицинский', type: 'Институт', specialties: ['Медицина', 'Стоматология', 'Фармация', 'Биология'], shortName: 'Сеченовка' },
    { id: 14, name: 'РЭУ им. Плеханова', location: 'Москва, ул. Стремянная, д. 36', students: '19 000', rank: 'Топ-3 экономический', type: 'Университет', specialties: ['Экономика', 'Менеджмент', 'Финансы', 'IT'], shortName: 'Плеханка' },
    { id: 15, name: 'МАРХИ', location: 'Москва, ул. Вадковский пер., д. 5', students: '8 000', rank: 'Топ-1 архитектурный', type: 'Институт', specialties: ['Архитектура', 'Дизайн', 'Инженерия', 'Градостроительство'], shortName: 'МАРХИ' },
    { id: 16, name: 'МГИМО', location: 'Москва, ул. Профсоюзная, д. 76', students: '11 000', rank: 'Топ-1 международных отношений', type: 'Университет', specialties: ['Международные отношения', 'Политология', 'Лингвистика', 'Право'], shortName: 'МГИМО' },
    { id: 17, name: 'Московская академия экономики и права', location: 'Москва, ул. Новослободская, д. 24', students: '14 000', rank: 'Топ-5 юридических', type: 'Академия', specialties: ['Право', 'Экономика', 'Менеджмент', 'Психология'], shortName: 'МАЭП' },
    { id: 18, name: 'МГУПИ', location: 'Москва, ул. Стромынка, д. 20', students: '9 000', rank: 'Топ-3 в информатике', type: 'Институт', specialties: ['IT', 'Информационная безопасность', 'Кибербезопасность', 'Медиа'], shortName: 'МГУПИ' },
    { id: 19, name: 'РТА МГТУ им. Баумана', location: 'Москва, ул. Малая Семёновская, д. 3', students: '7 500', rank: 'Топ-5 в робототехнике', type: 'Институт', specialties: ['Робототехника', 'Машиностроение', 'Информационные технологии', 'Автоматизация'], shortName: 'РТА' },
    { id: 20, name: 'МГУСИ', location: 'Москва, ул. Вадковский переулок, д. 1', students: '10 500', rank: 'Топ-4 в сервисе', type: 'Университет', specialties: ['Сервис', 'Туризм', 'Гостеприимство', 'Психология'], shortName: 'МГУСИ' },
    { id: 21, name: 'МГУЛ', location: 'Москва, ул. Садовая-Кудринская, д. 26', students: '6 000', rank: 'Топ-1 в лесном хозяйстве', type: 'Университет', specialties: ['Лесное хозяйство', 'Экология', 'Биотехнологии', 'Инженерия'], shortName: 'МГУЛ' },
    { id: 22, name: 'МГПУ', location: 'Москва, ул. Малая Пироговская, д. 1', students: '12 500', rank: 'Топ-2 в педагогике', type: 'Университет', specialties: ['Педагогика', 'Психология', 'Дефектология', 'Логопедия'], shortName: 'МГПУ' },
    { id: 23, name: 'МГТУ "СТАНКИН"', location: 'Москва, Вадковский пер., д. 3а', students: '8 500', rank: 'Топ-3 в машиностроении', type: 'Университет', specialties: ['Машиностроение', 'Робототехника', 'Информационные технологии', 'Экономика'], shortName: 'СТАНКИН' },
    { id: 24, name: 'Государственный академический университет гуманитарных наук', location: 'Москва, Мароновский переулок, д. 26', students: '4 000', rank: 'Топ-5 в гуманитарных науках', type: 'Университет', specialties: ['Философия', 'История', 'Литература', 'Психология'], shortName: 'ГАУГН' },
    { id: 25, name: 'Московский политехнический университет', location: 'Москва, ул. Большая Семёновская, д. 38', students: '15 000', rank: 'Топ-6 в технике', type: 'Университет', specialties: ['Инженерия', 'IT', 'Машиностроение', 'Электроника'], shortName: 'Московский политех' },
  ];

  const careerFields = [
    { id: 1, name: 'IT и Программирование', description: 'Карьера в сфере информационных технологий, разработки программного обеспечения, анализа данных и кибербезопасности.', icon: '💻', universityIds: [1, 2, 4, 5, 6, 9, 14, 18], directions: ['Программная инженерия', 'Информационные системы', 'Бизнес-информатика', 'Искусственный интеллект'], professions: ['Программист', 'Системный аналитик', 'Data Scientist', 'DevOps-инженер'] },
    { id: 2, name: 'Инженерия', description: 'Технические специальности, включая машиностроение, электронику, строительство и архитектуру.', icon: '⚙️', universityIds: [3, 5, 6, 11, 12, 15, 19, 23, 25], directions: ['Машиностроение', 'Робототехника', 'Электроника', 'Строительство'], professions: ['Инженер-механик', 'Электронщик', 'Конструктор', 'Архитектор'] },
    { id: 3, name: 'Медицина', description: 'Профессии в сфере здравоохранения, включая врачей, медсестер, фармацевтов и биологов.', icon: '🏥', universityIds: [1, 8, 13], directions: ['Лечебное дело', 'Стоматология', 'Фармация', 'Биология'], professions: ['Врач-терапевт', 'Хирург', 'Фармацевт', 'Биолог'] },
    { id: 4, name: 'Бизнес и Экономика', description: 'Финансы, маркетинг, управление, предпринимательство и международные отношения.', icon: '💼', universityIds: [4, 9, 14, 17], directions: ['Экономика', 'Финансы', 'Менеджмент', 'Международные отношения'], professions: ['Экономист', 'Финансист', 'Менеджер', 'Бизнес-аналитик'] },
    { id: 5, name: 'Право и Юриспруденция', description: 'Профессии в сфере права, включая юристов, адвокатов, нотариусов и сотрудников правоохранительных органов.', icon: '⚖️', universityIds: [7, 16, 17], directions: ['Юриспруденция', 'Правоохранительная деятельность', 'Международное право', 'Право и экономика'], professions: ['Юрист', 'Адвокат', 'Нотариус', 'Следователь'] },
    { id: 6, name: 'Педагогика и Психология', description: 'Образование, воспитание, изучение человеческой психики и поведения.', icon: '🎓', universityIds: [22, 17, 20], directions: ['Педагогика', 'Психология', 'Дефектология', 'Логопедия'], professions: ['Учитель', 'Психолог', 'Логопед', 'Дефектолог'] },
  ];
  ...
  const universityDirections = [
    ...
    { id: 2, university: 'МИСиС', direction: 'Информационные системы', faculty: 'ИКТИБ', careerFieldId: 1, relatedProfessions: ['Разработчик', 'Системный аналитик', 'Data Scientist'] },
    { id: 3, university: 'СПбПУ', direction: 'Робототехника', faculty: 'Физико-механический', careerFieldId: 2, relatedProfessions: ['Инженер-робототехник', 'Конструктор', 'Программист'] },
    { id: 4, university: 'НИУ ВШЭ', direction: 'Бизнес-информатика', faculty: 'Факультет компьютерных наук', careerFieldId: 4, relatedProfessions: ['Аналитик', 'Продуктовый менеджер', 'IT-консультант'] },
    { id: 5, university: 'МФТИ', direction: 'Прикладная математика', faculty: 'Аэромеханика и летательные аппараты', careerFieldId: 2, relatedProfessions: ['Математик', 'Инженер', 'Аналитик'] },
    { id: 6, university: 'МГТУ им. Баумана', direction: 'Машиностроение', faculty: 'Машиностроительный', careerFieldId: 2, relatedProfessions: ['Инженер-конструктор', 'Технолог', 'Проект-менеджер'] },
    { id: 7, university: 'Финансовый университет', direction: 'Финансы и кредит', faculty: 'Финансовый факультет', careerFieldId: 4, relatedProfessions: ['Финансист', 'Аналитик', 'Бухгалтер'] },
    { id: 8, university: 'Московский политех', direction: 'Информационные технологии', faculty: 'Факультет информационных технологий', careerFieldId: 1, relatedProfessions: ['Программист', 'Web-разработчик', 'Системный администратор'] },
    { id: 9, university: 'РХТУ им. Менделеева', direction: 'Химическая технология', faculty: 'Химико-технологический факультет', careerFieldId: 2, relatedProfessions: ['Химик-технолог', 'Инженер-химик', 'Лаборант'] },
    { id: 10, university: 'Первый МГМУ им. Сеченова', direction: 'Лечебное дело', faculty: 'Лечебный факультет', careerFieldId: 3, relatedProfessions: ['Врач-терапевт', 'Хирург', 'Педиатр'] },
    { id: 11, university: 'МГЮА', direction: 'Юриспруденция', faculty: 'Правовой факультет', careerFieldId: 5, relatedProfessions: ['Юрист', 'Адвокат', 'Нотариус'] },
    { id: 12, university: 'МГИМО', direction: 'Международные отношения', faculty: 'Международный факультет', careerFieldId: 4, relatedProfessions: ['Дипломат', 'Переводчик', 'Аналитик'] },
    { id: 13, university: 'МГПУ', direction: 'Педагогика', faculty: 'Факультет педагогики', careerFieldId: 6, relatedProfessions: ['Учитель', 'Методист', 'Психолог'] },
    { id: 14, university: 'РТА', direction: 'Робототехника', faculty: 'Факультет робототехники', careerFieldId: 2, relatedProfessions: ['Инженер-робототехник', 'Программист', 'Конструктор'] },
    { id: 15, university: 'СТАНКИН', direction: 'Машиностроение', faculty: 'Машиностроительный факультет', careerFieldId: 2, relatedProfessions: ['Инженер-конструктор', 'Технолог', 'Программист'] },
  ];
        ...
        <div className="py-8">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 shadow-lg">
            ...
            <div className="flex gap-4">
              <button className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 px-8 py-3 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-105">
                Подать заявку
              </button>
              <button className="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 px-8 py-3 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-105">
                Посетить сайт
              </button>
            </div>
          </div>
